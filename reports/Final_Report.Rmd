...
Python and R are the two dominate Data Science programming languages, we set out to determine how people's background influenced their choice. In particular we wanted to answer the following question:  
